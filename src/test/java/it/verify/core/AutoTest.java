...
public class AutoTest extends CommonTestBase {
	...
	public void test() {
		...
		db.update("insert into a1 (id,char_type,varchar_type,integer_type,date_type,time_type,timestamp_type,"
				...
				+ "'1990-05-10T15:26:41.001',27384.01,true,2734901,27369.010,'clob_type 2733201',"
		...
		db.update("insert into a1 (id,char_type,varchar_type,integer_type,date_type,time_type,timestamp_type,"
				...
				+ "'1990-05-11T15:26:42.002',27384.02,false,2734902,27369.020,'clob_type 2733202',"
		...
		db.update("insert into a2 (id,char_type,varchar_type,integer_type,date_type,time_type,timestamp_type,"
				...
				+ "'1960-03-27T15:13:20',3184.0,false,314900,3169.0,'clob_type 0313200',"
		...
		db.update("insert into a2 (id,char_type,varchar_type,integer_type,date_type,time_type,timestamp_type,"
				...
				+ "'1960-03-28T15:13:21.001',3184.010,true,314901,3169.01,'clob_type 0313201',"
