...
public class DataTypesOracleTest extends DataTypesTestBase {
	...
	public static void createTable() {
		db.execute("create table data_types (id number(10,0) primary key, char_type char(20), "
				+ "varchar_type varchar(50), varchar2_type varchar2(50), integer_type integer, "
				+ "date_type date, time_type timestamp, timestamp_type timestamp, "
				+ "float_type binary_float, double_type binary_double, boolean_type number(1), bigint_type number(19), "
				+ "decimal_type decimal(20,5), clob_type clob, blob_type blob, binary_type raw(8))");
