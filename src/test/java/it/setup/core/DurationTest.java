...
public class DurationTest extends CommonTestBase {
	...
	@Test
	public void test() {
		assertEquals("Count", new Integer(5), db.queryForObject("select count(*) from a", Integer.class));
		...
		// @timestamp:
		verifyRow(3, new LocalDate(2007, 5, 24), new LocalTime(21, 53, 3),
	...
	private void verifyRow(int id, LocalDate date1, LocalTime time1, DateTime timestamp1) {
