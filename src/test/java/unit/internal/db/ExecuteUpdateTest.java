...
public class ExecuteUpdateTest implements Keywords {
	...
	public void insertDataTypesH2() {
		...
		h2.db.execute("create table data_types (id int primary key," +
				...
				" clob_type clob, nclob_type nclob, blob_type blob, uuid_type uuid, array_type array)");
		...
		String sql = "insert into data_types (id," +
				...
				"clob_type,nclob_type,blob_type,uuid_type,array_type)" +
				" values (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
		ExecuteUpdate.run(h2.getConnection(),
				createStatements(
						sql,
						createParameters(INTEGER, Types.INTEGER, 1,
								...
								FIXED_STRING, Types.CHAR, "char1   ",
								STRING, Types.VARCHAR, "varchar1",
								STRING, Types.LONGVARCHAR, "longvarchar1",
								FIXED_NSTRING, Types.NCHAR, "nchar1   ",
								NSTRING, Types.NVARCHAR, "nvarchar1",
								NSTRING, Types.LONGNVARCHAR, "longnvarchar1",
								...
								ARRAY_STRING, Types.ARRAY, new String[]{"value 1", "value 2", "value 3"}
						),
						sql,
						createParameters(INTEGER, Types.INTEGER, 2,
								...
								FIXED_STRING, Types.CHAR, null,
								STRING, Types.VARCHAR, null,
								STRING, Types.LONGVARCHAR, null,
								FIXED_NSTRING, Types.NCHAR, null,
								NSTRING, Types.NVARCHAR, null,
								NSTRING, Types.LONGNVARCHAR, null,
		...
		String expected = "[{ID=1, BIT_TYPE=false, BOOLEAN_TYPE=true," +
				...
				" ARRAY_TYPE=[Ljava.lang.String;REPLACED" +
				"}," +
				...
				" CLOB_TYPE=null, NCLOB_TYPE=null, BLOB_TYPE=null, UUID_TYPE=null, ARRAY_TYPE=null}]";
