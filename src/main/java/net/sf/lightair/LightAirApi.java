 ...
 * <p>
 * The general contract is to {@link LightAirApi#initialize(String)} and {@link LightAirApi#shutdown()}
 * and in between perform either {@link LightAirApi#generateXsd()} call
 * or (a series of) {@link LightAirApi#setup(Map)} and {@link LightAirApi#verify(Map)} or {@link LightAirApi#await(Map)} calls.
 * <p>
 ...
 * </pre>
 */
public class LightAirApi implements Keywords {

	private static final Logger log = LoggerFactory.getLogger(LightAirApi.class);
	 ...
	 * <p>
	 * NOTE: ALWAYS call {@link LightAirApi#shutdown()} after initialize() to properly release resources.
	 *
	...
	public static void initialize(String propertiesFileName) {
		...
		LightAirApi.propertiesFileName = propertiesFileName;
